...
import type { EncryptionConfiguration } from '@cosmjs/amino/build/wallet';
import type { EnglishMnemonic, HdPath } from '@cosmjs/crypto';
...
export declare function extractKdfConfiguration(
